...
PAGE 1 :   /* Data Memory */
	...
	RAML45       : origin = 0x00C000, length = 0x002000     /* on-chip RAM block L4 */
...
/*** Initialized Sections ***/                                          
	...
	.pinit			:   LOAD = FLASHF,  	PAGE = 0        /* can be ROM */
                		RUN = RAM_L0L1L2L3, PAGE = 0        /* must be CSM secured RAM */
                		LOAD_START(_pinit_loadstart),
                		RUN_START(_pinit_runstart),
                		SIZE(_pinit_size)

	.switch			:   LOAD = FLASHG,  	PAGE = 0        /* can be ROM */
                		RUN = RAM_L0L1L2L3, PAGE = 0        /* must be CSM secured RAM */
                		LOAD_START(_switch_loadstart),
                		RUN_START(_switch_runstart),
                		SIZE(_switch_size)

	.text			:   LOAD = FLASHH, 		PAGE = 0        /* can be ROM */
                		RUN = RAM_L0L1L2L3, PAGE = 0        /* must be CSM secured RAM */
